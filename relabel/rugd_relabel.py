...
def apply_color_mapping(image_array, color_mapping):
  """
  This function creates the color mapping

  Args: original mask, color mapping
...
folder_path = "/home/nb1/spilkova/data/RUGD/rugd_split/test"
all_files = os.listdir(folder_path)
mask_files = [file for file in all_files if file.endswith("_mask.png")]

for mask_file in mask_files:
    print(mask_file)

    img_path = os.path.join(folder_path, mask_file)
